...
SECRET_KEY = os.environ.get('SECRET_KEY', '205rh##sb)p-h(**@43v#i0i5(r_-fh9ifasd5u7gc!km+r0l9')
...
INSTALLED_APPS = [
    ...
    'django_extensions',
    'recurrence',
    'gestor.app_labels.ScheduleFriendlyConfig',
    'gestor.app_labels.NotificationsFriendlyConfig',
    'crispy_forms',
    "crispy_bootstrap5",
